...
public class LapisTorchItem extends VerticallyAttachableBlockItem {
    /**
     * @param standingBlock
     * @param wallBlock
     * @param settings
     ...
     */
    public LapisTorchItem(Block standingBlock, Block wallBlock, Settings settings, Direction verticalAttachmentDirection) {
